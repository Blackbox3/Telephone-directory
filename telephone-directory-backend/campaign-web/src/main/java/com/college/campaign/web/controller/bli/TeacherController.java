...
public class TeacherController {
    ...
    public ResponseEntity<?> getCampaignList(@NotNull @Valid @RequestBody TeacherSearchRequest teacherSearchRequest) {
        TelephoneDirectoryResponses telephoneDirectoryResponses = teacherService.searchCampaign(teacherSearchRequest);
    ...
    public ResponseEntity<?> createTeacher(@NotNull @Valid @RequestBody TeacherCreateRequest teacherCreateRequest) {
        TelephoneDirectoryResponses telephoneDirectoryResponses = teacherService.createTeacher(teacherCreateRequest);
        return ResponseBuilder.response(telephoneDirectoryResponses);
    }
