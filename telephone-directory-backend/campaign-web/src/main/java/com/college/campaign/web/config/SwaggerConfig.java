...
public class SwaggerConfig {
    ...
    Predicate<RequestHandler> predicate = (RequestHandler input) -> {
        ...
        if (declaringClass.getPackage().getName().startsWith("com.college.campaign")) {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Campaign ").description("Web portal for Campaign Web service")
                .termsOfServiceUrl("https://college.com").contact(new Contact("college", "https://wwww.college.com", "banksmart@college.com"))
                .license("JavaInUse License")
                .licenseUrl("banksmart@college.com").version("1.0").build();
    }
