...
import com.college.campaign.common.manager.MessageLoader;
...
public class MessageComposer {
    ...
    public static TelephoneDirectoryResponses compose(TelephoneDirectoryResponses telephoneDirectoryResponses, String key, Map<String, String> parameters) {

        Message formattedMessage = compose(key, parameters);

        telephoneDirectoryResponses.setMessage(formattedMessage.getMessage());
        return telephoneDirectoryResponses;
    }

    public static TelephoneDirectoryResponses compose(TelephoneDirectoryResponses telephoneDirectoryResponses, String key) {
